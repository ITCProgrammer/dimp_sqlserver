<?php
    ...
    $query_barang  = "SELECT * FROM tbl_master_barang_atk_tq where id='$id_barang' LIMIT 1";
    ...
    $query_data = "SELECT t.*,a.VALUESTRING as KETERANGAN
        ...
        AND t.WAREHOUSELOCATIONCODE ='002'
        ...
        AND t.TRANSACTIONDATE > '2025-11-26'
    ...
    if (empty($data)) {
        $data[] = [
            ...
            'nama'                 => '',
            'paraf'                => '',
            'keterangan'           => 'Balance per 27 November 2025',
        ];
    }
